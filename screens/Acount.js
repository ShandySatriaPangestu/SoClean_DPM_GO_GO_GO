...
import PrivacyFormContainer1 from "../components/PrivacyFormContainer1";
    ...
    <View style={styles.acount}>
      ...
      >
        <Image
          ...
          contentFit="cover"
          source={require("../assets/barcode6.png")}
        />
      </Pressable>
      <Image
      ...
      >
        <Image
          style={[styles.icon, styles.iconLayout]}
          contentFit="cover"
          source={require("../assets/news7.png")}
        />
      </Pressable>
      <Image
