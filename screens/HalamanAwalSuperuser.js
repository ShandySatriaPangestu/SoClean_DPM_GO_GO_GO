...
const HalamanAwalSuperuser = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.halamanAwalSuperuser}>
      <Pressable
        style={[styles.rectangleParent, styles.rectangleLayout]}
        onPress={() => navigation.navigate("LoginSuperuser")}
      >
...
export default HalamanAwalSuperuser;
