...
const Newsletter2 = () => {
  return (
    <View style={styles.newsletter}>
      <View style={styles.frameScrollNews}>
        <View style={[styles.frameNews, styles.iconPosition]}>
          <Image
            style={[styles.idntimes1Icon, styles.iconPosition]}
            contentFit="cover"
          ...
          />
          <View style={[styles.judul, styles.iconPosition]}>
            <Text
              style={styles.faktaGunungSampah}
