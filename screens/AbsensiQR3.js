...
const AbsensiQR3 = () => {
  ...
  return (
    <View style={styles.absensiQr3}>
      <Image
        style={styles.absensiQr3Child}
        contentFit="cover"
        source={require("../assets/rectangle-4191.png")}
      />
      <Text style={styles.kembaliKeMenu}>kembali ke menu utama</Text>
      <FormContainer iPhoneStatusBarLeft={-20} />
      <Image
        style={styles.absensiQr3Item}
        contentFit="cover"
        source={require("../assets/ellipse-150.png")}
      />
      <Image
        style={styles.absensiQr3Inner}
        contentFit="cover"
