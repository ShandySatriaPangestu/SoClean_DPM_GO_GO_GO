...
const CustomerService1 = () => {
  ...
  return (
    <View style={styles.customerService1}>
      <View style={[styles.customerService1Child, styles.customerPosition]} />
      <Pressable
        style={styles.vector}
      ...
      />
      <View style={[styles.customerService1Item, styles.customerPosition]} />
      <Pressable
        style={styles.wrapper}
        onPress={() => navigation.navigate("CustomerService2")}
      >
        <Image
